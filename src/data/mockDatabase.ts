...
export const mockEvents: UpdateEvent[] = [
  ...
  {
    id: 'e2',
    title: 'Final Semester Examinations Phase 1 Schedule',
    description: 'The definitive timetable for Semester 8 final examinations has been released on the official syllabus portal.',
  ...
  {
    id: 'e3',
    title: 'Inter-College Hackathon: CodeBreakers',
    description: 'A 48-hour continuous coding hackathon powered by university alumni networks. First prize up to $5000.',
  ...
  {
    id: 'e4',
    title: 'Campus Central Library Renovation',
    description: 'The central library will be partially closed in the East wing for lighting upgrades during the weekend.',
